...
const lines = [
    ...
    "> echo 'Jack into the datasphere to outmaneuver corp rivals, Anon.'",
    "> Loading modules...",
    "mod-load --inject \"blackice.exe\"",
    "> echo 'No frontal assault; we're ghost-modding, injecting our proprietary blackice.'",
    "> tech-scrape --target hottest_tech --filter latest",
    "> echo 'Cherry-picking the hottest tech and recoding it into a reality-warping expansion pack.'",
    "> recode --expansion --mode warp",
    "> echo 'Users'll get their synapses rewired experiencing a whole new level of digital ecstasy.'",
    "> market-drop --mode stealth --value high",
    "> echo 'This lets us stealth-drop into the market, dodging aggro while delivering god-tier value to the meat puppets.'",
    "> echo 'In the long game, we'll be the chrome-plated cyber-shamans of the new digital frontier.'",
